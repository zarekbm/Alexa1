...
// --- Skill code (igual al que compartiste, solo adaptado para que use process.env correctamente) ---

const WEB_APP_URL = process.env.GOOGLE_APP_SCRIPT_URL;
...
app.get('/', (req, res) => {
  res.send('Servidor Alexa Skill para medicamentos funcionando!');
});
